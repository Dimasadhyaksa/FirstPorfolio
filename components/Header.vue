      ...
      <header class="fixed top-0 left-0 z-50 flex w-full items-center bg-transparent"
        ...
        <div class="container">
          <div class="relative flex items-center justify-between">
            <div class="px-4">
              <router-link to="#home" class="block py-3 text-lg font-bold text-[#facc15] ">
                Dimas AY
              </router-link>
            </div>
            <div class="flex items-center justify-center px-4">
              ...
              <nav id="nav-menu" :class="{ 'hidden': !isHamburgerActive }"
                ...
                <ul class="block lg:flex">
                  <li class="group">
                    <NuxtLink to="#home"
                      class="mx-8 flex py-2 text-sm text-white group-hover:text-orange-300 group-hover:underline  ">
                      Home
                    </NuxtLink>
                  </li>
                  <li class="group">
