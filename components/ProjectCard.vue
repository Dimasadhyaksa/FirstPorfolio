<template>
    <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10 mt-8 ">
            <div class="bg-white/5 border  p-5 rounded-3xl " v-for="project in datas" :key="project.id" ref="project">
                <NuxtLink :to="`/project/` + project.id">

                    <img :src="project.image" alt="gamar"
                        class="rounded-2xl mb-5 shadow-xl w-full h-[200px] hover:scale-105 duration-300" width="400px"
                ...
                <div class="inline-flex items-center mb-2">
                    <div class="inline-flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-6 text-white mr-2 h-6">
