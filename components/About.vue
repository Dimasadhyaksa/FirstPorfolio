<template>
  <!-- about s -->
  <section id="about" class="pt-10 dark:bg-dark bg-[#27272a]">
    <div class="container">
      <div class="flex flex-wrap">
        <div class="w-full self-center px-10 lg:w-1/2">
          <h4 class="mb-3 text-lg font-bold text-slate-300">Tentang Saya</h4>
          <h2 class="mb-0 max-w-md text-3xl font-bold text-dark text-[#facc15] lg:text-4xl font-Fredoka">Dimas.</h2>
          <p class="max-w-xl text-base font-medium lg:text-lg text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit. Id temporibus maiores sequi vitae saepe iusto deleniti sukas suka ksukasdkfhlhih kh !</p>
        ...
        <div class="w-full self-end px-4 lg:w-1/2">
          <div class="relative mt-10 lg:right-0 lg:mt-9">
            <img src="~/assets/image/cat-coding.png" alt="Sandhika Galih" class="relative z-10 mx-auto max-w-full hover:rotate-180" />
